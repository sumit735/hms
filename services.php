...
<section class="pb100">
   ...
   <div class="row justify-content-center no-gutters">
        <div class="container">
            <div class="row">
                <div class="col">
                    <img class="img1" src="assets/img/speakers/s13.png" alt="speaker name">
                </div>
                <div class="col mov">
                    <h4><span>Corporate</span> Event</h4>
                    <hr class="line">          
                ...
                <div class="w-100"></div>
                <div class="col mov">
                    <h4><span>Wedding</span> Event</h4> 
                    <hr class="line">          
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.</p>
                </div>
                <div class="col">
                    <img class="img1" src="assets/img/speakers/s14.png" alt="speaker name">
                </div>
                <div class="w-100"></div>
                <div class="col">
                    <img class="img1" src="assets/img/speakers/s16.png" alt="speaker name">
                </div>
                <div class="col mov">
                    <h4><span>Birthday</span> Event</h4>
                    <hr class="line">           
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.</p>
                </div>
                <div class="w-100"></div>
                <div class="col mov">
                    <h4><span>Promotion</span> Event</h4>  
                    <hr class="line">         
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum.</p>
                </div>
                <div class="col">
                    <img class="img1" src="assets/img/speakers/s15.png" alt="speaker name">
                </div>
            </div>
        </div>
   </div>
